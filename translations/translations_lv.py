...
Padoms: Kontekstizvēlnē varat mainīt iestatījumus.
        ...
        "redact_add_white": "Izs

        # ... (remaining translations for lv.py would follow here)
    }
```

---

Da die Lettisch-Übersetzung aufgrund der Länge unterbrochen wurde, muss ich sie im nächsten Block vervollständigen.

Möchtest du, dass ich Block 11 mit der Vervollständigung von Lettisch und dann den nächsten Sprachen (Mongolisch, Marathi, Malaiisch) fortsetze?

Block 11 - Lettisch (Vervollständigung) + Mongolisch + Marathi

translations_lv.py 🇱🇻 Lettisch (vollständig - Fortsetzung)
...
def load_latvian_strings():
    return {
        ...
        # ============================================
        # 104. PROGRAMM BEENDEN
        # ============================================
        "app_quitting": "Lietotne tiek aizvērta",
