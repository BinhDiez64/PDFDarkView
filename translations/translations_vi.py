...
Mẹo: Bạn có thể điều chỉnh cài đặt trong menu ngữ cảnh.
        ...
        # 104. UPDATE
        # ============================================
        "update_available_title": "Phiên bản mới có sẵn",
        "update_available_message": "Có phiên bản mới <b>{0}</b>.\n\nVui lòng truy cập trang phát hành để tải xuống bản cập nhật:\n{1}",
        "update_available_voice": "Phiên bản mới {0} có sẵn. Vui lòng tải xuống bản cập nhật từ trang GitHub.",
        ...
        "ask_download_all_translations": """Ngoài tiếng Đức, tiếng Anh và tiếng Việt, còn có 60 ngôn ngữ giao diện khác.\n\nBạn có muốn cung cấp / cập nhật chúng không?\n\n
        Lưu ý:\nCác ngôn ngữ không cần dùng, bạn có thể tự xóa sau trong thư mục:\n{translations_path}\n\nNếu hủy, bạn có thể tải ngôn ngữ giao diện sau qua menu 'Công cụ → Cập nhật bản dịch'.""",
        "menu_update_translations": "Cập nhật bản dịch",
        "translations_updated": "Đã cập nhật bản dịch",
        "translations_update_success": "Đã cập nhật thành công {} bản dịch ({} mới, {} cập nhật).",
        "translations_update_error": "Lỗi khi cập nhật bản dịch",
        "translations_update_no_changes": "Tất cả bản dịch đều đã mới nhất.",
        ...
        # ============================================
        # 106. PROGRAMM BEENDEN
        # ============================================
        "app_quitting": "Đang tắt ứng dụng",
