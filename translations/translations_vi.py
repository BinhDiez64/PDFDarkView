...
Mẹo: Bạn có thể điều chỉnh cài đặt trong menu ngữ cảnh.
        ...
        <p><b>📖 Trợ giúp về mã ngôn ngữ:</b> Có thể tìm thấy danh sách đầy đủ trong <a href="https://tesseract-ocr.github.io/tessdoc/Data-Files#data-files-for-version-400-november-29-2016">tài liệu Tesseract</a>.</p>
        </body>
        </html>
        """,
        ...
        <li>Đi đến: <a href="https://github.com/tesseract-ocr/tessdata">https://github.com/tesseract-ocr/tessdata</a></li>
