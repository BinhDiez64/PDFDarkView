...
Tip: You can adjust settings in the context menu.
        ...
        "update_available_message": "A new version <b>{0}</b> is available.\n\nVisit the release page to download the update:\n{1}",
        ...
        "ask_download_all_translations": """In addition to German, English and Vietnamese, 60 other GUI languages are available.\n\nShould they be provided / updated?\n\n
        Note:\nLanguages you don't need can later be deleted manually in the directory:\n{translations_path}\n\nIf you cancel, you can download the GUI languages later via the menu 'Tools → Update translations'.""",
        ...
        "translations_update_in_progress": "Updating translations in the background...",
        ...
        # ============================================
        "app_quitting": "Application is shutting down",
