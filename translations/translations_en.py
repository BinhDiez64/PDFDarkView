...
Tip: You can adjust settings in the context menu.
        ...
        <p><b>📖 Help with language codes:</b> A complete list is available in the <a href="https://tesseract-ocr.github.io/tessdoc/Data-Files#data-files-for-version-400-november-29-2016">Tesseract documentation</a>.</p>
        </body>
        </html>
        """,
        ...
        <li>Go to: <a href="https://github.com/tesseract-ocr/tessdata">https://github.com/tesseract-ocr/tessdata</a></li>
